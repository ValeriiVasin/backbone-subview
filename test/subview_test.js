...
import ChildMixinDist from '../dist/subview';

describe('ChildMixin: source', testChildMixin(ChildMixin));
describe('ChildMixin: build', testChildMixin(ChildMixinDist));

function testChildMixin(ChildMixin) {
  return function () {
